...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization Bearer Hl1VpBnFNksYXISLveLXgs98aFuOcLNq' http://fb88ce29-8962-4e6f-a0f7-6e9775edcf5e.southcentralus.azurecontainer.io/score
